...
def get_logo_image(size: Optional[Tuple[int, int]] = None) -> Optional[ImageTk.PhotoImage]:
...
def apply_background_image(root: tk.Misc, size: Tuple[int, int] = (420, 420)) -> Optional[tk.Label]:
